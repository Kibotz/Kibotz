...
exports.UmurXReg = () =>{
	return`Umur kamu terlalu tua, keren kek/nek`
	}
...
├ ${prefix}tovn [video]
├ ${prefix}stikergif
├ ${prefix}stikervideo [kirim video 10s]
├ ${prefix}smeme [text]
├ ${prefix}smeme2 [text|text]
├ ${prefix}colongstiker <Packname>|<Author>
├ ${prefix}stikerwm <Packname>|<Author>
...
exports.leave = () =>{
	return`Yah Kenapa Kamu? Kok Out ಥ‿ಥ
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
...
Recode : https://github.com/Kinoooooook/Rfzzxi
`
}
